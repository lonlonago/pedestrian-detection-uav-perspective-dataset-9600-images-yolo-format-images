# Pedestrian Detection UAV Perspective Dataset 9600 Images YOLO Format Images

# Body

Pedestrian Detection UAV Perspective Dataset, 9600 Images in YOLO format, clear images with complete annotations, suitable for pedestrian target detection model training, supports UAV perspective scene, large data volume, ready to use, saves time and effort
